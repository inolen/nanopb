...
typedef struct pb_decode_if_s pb_decode_if_t;
...
struct pb_msgdesc_s {
    ...
    bool (*init)(pb_decode_if_t *, void *, unsigned int);
    bool (*decode)(pb_decode_if_t *, pb_istream_t *, void *, unsigned int, uint32_t, pb_wire_type_t);
    void (*release)(pb_decode_if_t *, void *, unsigned int, uint32_t);
...
#define PB_INIT(structname) NULL
